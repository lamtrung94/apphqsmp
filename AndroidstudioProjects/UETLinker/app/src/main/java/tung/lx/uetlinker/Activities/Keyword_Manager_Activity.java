...
public class Keyword_Manager_Activity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyword__manager_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.keyword__manager_, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_keyword__manager_layout, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((Keyword_Manager_Activity) activity).onSectionAttached(
