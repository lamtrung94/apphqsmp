...
public class MainActivity extends Activity implements OnClickListener, 
	...
	DatabaseHelper mDb;
	Button mButton1, mButton2, mButton3, mBtnSettings;
	TextView mlblTitle;
	...
	private void Initialize(){
		...
		mButton1.setText(Global.contactList.get(0).getName() + " (" + Global.contactList.get(0).getNum() + ")");
		mButton2.setOnClickListener(this);
		mButton2.setText(Global.contactList.get(1).getName() + " (" + Global.contactList.get(1).getNum() + ")");
		mButton3.setOnClickListener(this);
		mButton3.setText(Global.contactList.get(2).getName() + " (" + Global.contactList.get(2).getNum() + ")");
		mBtnSettings.setOnClickListener(this);
		mBtnSettings.setText(getResources().getString(R.string.settings));
		mlblTitle.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.alarmicon), null, null, null);
		mDb.close();
	}
	...
	public void onClick(View v) {
		if (v.getId() == R.id.btnSOS1){
			...
			Intent i = new Intent();
			i.setClass(getApplicationContext(), SettingsScreen.class);
			startActivity(i);
		}
	}
	...
	private void triggerSOS(){
		...
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:"+Global.contactList.get(0).getNum())); 
	...
	private void triggerSOS(int index){
		Utilities.enableNetwork(MainActivity.this);
		mLocationClient.connect();
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:"+Global.contactList.get(index).getNum())); 
        startActivity(callIntent);
	}
